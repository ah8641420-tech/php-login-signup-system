...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $existSql = "SELECT * FROM `logindata` WHERE `Email` = '$email'";
    ...
    if ($numRowExist > 0) {
        ...
        if ($password == $confirm_password) {
            ...
            $sql = "INSERT INTO `logindata`(`Email`, `Password`) VALUES ('$email', '$hash')";
    ...
    ?>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="signup.php" method="POST" class="space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="confirm-password" class="block text-sm/6 font-medium text-gray-100">Confirm
                            Password</label>
                    </div>
                    <div class="mt-2">
